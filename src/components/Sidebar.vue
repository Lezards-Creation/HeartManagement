                                    ...
                                    <template v-if="activityItem.type === 'comment'">
                                          ...
                                          <div class="min-w-0 flex-1">
                                                <div>
                                                      ...
                                                      <p class="mt-0.5 text-sm text-gray-500">Commented {{ activityItem.date
                                                      }}</p>
                                                </div>
                                          ...
                                          <div class="min-w-0 flex-1 py-1.5">
                                                <div class="text-sm text-gray-500">
                                                      ...
                                                      <a :href="activityItem.assigned.href"
                                                            class="font-medium text-gray-900">{{ activityItem.assigned.name
                                                            }}</a>
                                                      {{ ' ' }}
                                                      ...
                                                      <span class="mr-0.5">
                                                            <template v-for="tag in activityItem.tags" :key="tag.name">
                                                                  <a :href="tag.href"
                                                                        ...
                                                                        <svg :class="[tag.color, 'h-1.5 w-1.5']"
...
const activity = [
      ...
      },
      {
            ...
            tags: [
                  ...
                  { name: 'Accessibility', href: '#', color: 'fill-rose-500' },
            ],
            date: '6h ago',
      },
      {
