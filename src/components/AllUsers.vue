									...
									<div class="panel p-0 max-h-0 overflow-hidden duration-300 ease-out">
										<div class="container grid grid-cols-1 gap-x-4 gap-y-4 pt-6 pb-4 sm:grid-cols-6">
											...
											<div class="sm:col-span-3">
												...
												<div class="mt-2">
													<input v-model="filters.cp_cli" type="text" name="cp_cli" id="cp_cli" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-rose-600 sm:text-sm sm:leading-6">
												</div>
											</div>
