<script setup>
    ...
    // #region VARIABLES
    const props = defineProps(['client', 'isOpen', 'generate', 'type']);
                ...
                <div id="pdf">
                    <div class="page flex flex-col overflow-hidden relative p-8" ref="page">
                        ...
                        <div class="border-b border-bleu/20 pb-2 flex justify-between">
                            <div class="basis-4/6">
                                <div>
                                    <p class="text-bleu text-sm mb-2">M./Mme X - Votre numéro de dossier : n°XXXXXX</p>
                                    ...
                                    <span class="font-[Avenir] text-sm"></span>
                                </div>
                            </div>
                            <div>
                        ...
                        <div class="flex justify-center mt-12 flex-wrap">
                            <div class="basis-full">
                                <p class="text-center">
                                    ...
                                    <span class="text-rose block text-lg leading-5">de rencontrer {{ current_user.pNoms_cli }}</span>
                                </p>
                            </div>
                        ...
                        <div class="border-2 rounded-3xl border-rose pt-5 pb-5 px-10 mt-4 relative">
                            ...
                            <div class="flex justify-between">
                                <div>
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        ...
                                        <span class="font-[Avenir]">{{ current_user.ref_cli }}</span>
                                    </p>
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        <span class="text-rose font-black">Profession : </span>
                                        <span class="font-[Avenir]">{{ current_user.prof_cli }}</span>
                                    </p>
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        <span class="text-rose font-black">Âge :</span >
                                        <span class="font-[Avenir]">{{ calculateAge(current_user.dateNaiss_cli) }} ans</span>
                                    </p>
                                </div>
                                ...
                                <div>
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        ...
                                        <span class="font-[Avenir]">{{ current_user.taille_cli }} cm</span>
                                    </p>
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        <span class="text-rose font-black">État civil :</span>
                                        <span class="font-[Avenir]">
                                            {{ current_user.situation_cli.celib_cli ? 'Célibataire,' : '' }}
                                    ...
                                    <p class="font-normal text-sm leading-5 space-x-1">
                                        ...
                                        <span class="font-[Avenir]">{{ current_user.chargeEnf_cli }} enfant(s) à charge </span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-2 mt-4">
                                <p class="font-normal text-sm leading-5 space-x-1">
                                    ...
                                    <span class="font-[Avenir]">{{ current_user.desc_cli }}</span>
                                </p>

                                <p class="font-normal text-sm leading-5 space-x-1">
                                    <span class="text-rose font-black">Centres d'intérêt : </span>
                                    <span class="font-[Avenir]">{{ current_user.interets_cli }}</span>
                                </p>
                        ...
                        <div class="border-y border-bleu/20 mt-4 py-4">
                            <div class="font-[Avenir]" v-if="type !== 'renc'">
                                ...
                                <div class="mt-4">
                                    ...
                                    <div class="mt-2" v-if="current_user.affAnn_cli === 'O'">
                                        <p class="text-xs" v-html="current_user.nroAnn_cli == '1' ? current_user.ann1_cli : current_user.ann2_cli"></p>
                                    </div>
                                </div>
                            </div>
