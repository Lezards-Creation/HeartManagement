...
const steps = ref([
    ...
    { id: '02', name: 'Données personnelles', slug: 'donnees_personnelles', status: 'upcoming' },
    { id: '03', name: 'Situation / recherche', slug: 'recherche',status: 'upcoming' },
]);
...
<template>
    <div class="h-screen flex-1 p-10 overflow-y-auto">
        ...
        <form  method="POST" @submit.prevent="" class="bg-gray-50 p-10 mt-4 rounded-xl">
                        ...
                        <div class="sm:col-span-2 self-end mb-2">
                            <SwitchGroup as="div" class="flex items-center">
                                <Switch 
                                    ...
                                    :class="['bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2']">
                                    <span aria-hidden="true"
                        ...
                        <div class="max-w-2xl space-y-10 col-span-full">
                            <fieldset>
                                ...
                                <div class="mt-6 grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                    <div class="sm:col-span-2 self-end mb-2">
                                        <SwitchGroup as="div" class="flex items-center">
                                            <Switch v-model="dataCreation.celib_cli"
                                                :class="[dataCreation.celib_cli  ? 'bg-rose-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2']">
                                                <span aria-hidden="true"
                                                    :class="[dataCreation.celib_cli ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                                            </Switch>
                                            <SwitchLabel as="span" class="ml-3 text-sm">
                                                <span class="font-medium text-gray-900">Célibataire</span>
                                            </SwitchLabel>
                                    ...
                                    <div class="sm:col-span-2 self-end mb-2">
                                        <SwitchGroup as="div" class="flex items-center">
                                            <Switch v-model="dataCreation.veuf_cli"
                                                :class="[dataCreation.veuf_cli ? 'bg-rose-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2']">
                                                <span aria-hidden="true"
                                                    :class="[dataCreation.veuf_cli ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                                            </Switch>
                                            <SwitchLabel as="span" class="ml-3 text-sm">
                                                <span class="font-medium text-gray-900">Veuf</span>
                                            </SwitchLabel>
                                    ...
                                    <div class="sm:col-span-2 self-end mb-2">
                                        <SwitchGroup as="div" class="flex items-center">
                                            <Switch v-model="dataCreation.div_cli"
                                                :class="[dataCreation.div_cli ? 'bg-rose-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2']">
                                                <span aria-hidden="true"
                                                    :class="[dataCreation.div_cli ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                                            </Switch>
                                            <SwitchLabel as="span" class="ml-3 text-sm">
                                                <span class="font-medium text-gray-900">Divorcé</span>
                                            </SwitchLabel>
                                    ...
                                    <div class="sm:col-span-2 self-end mb-2">
                                        <SwitchGroup as="div" class="flex items-center">
                                            <Switch v-model="dataCreation.sep_cli"
                                                :class="[dataCreation.sep_cli ? 'bg-rose-600' : 'bg-gray-200', 'relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-rose-600 focus:ring-offset-2']">
                                                <span aria-hidden="true"
                                                    :class="[dataCreation.sep_cli ? 'translate-x-5' : 'translate-x-0', 'pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out']" />
                                            </Switch>
                                            <SwitchLabel as="span" class="ml-3 text-sm">
                                                <span class="font-medium text-gray-900">Séparé</span>
                                            </SwitchLabel>
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button v-if="step_index !== steps.length - 1" type="button" class="text-sm font-semibold leading-6 text-gray-900" @click="nextStep">Suivant</button>
                <button type="submit" @click="handleCreationFiche" class="rounded-md bg-rose-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-rose-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-600">Finaliser</button>
            </div>
        </form>
    </div>
</template>